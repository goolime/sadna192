...
namespace sadna192.Tests
{
    ...
    public class RemoveOwner_AT
    {
        ...
        public void init()
        {
            ...
            if (userServiceLayer2.Register("removeOwnerUser2", "87654GfdF"))
                userServiceLayer2.Login("removeOwnerUser2", "87654GfdF");

            userServiceLayer1 = serviceLayer.Connect();
            if (userServiceLayer1.Register("removeOwnerUser", "1221YhnN"))
        ...
        public void remove_shop_owner_that_is_not_owner_test()
        {
            ...
            bool reg = userServiceLayer3.Register("removeOwnerUser3", "9999GThy");

            Assert.ThrowsException<Exception>(() => { userServiceLayer1.Remove_Store_Owner("shopit", "removeOwnerUser3"); }, "faild to remove owner that was not defined to be an owner");
        }
        ...
        public void remove_owner_that_defined_by_someonelse_test()
        {
            ...
            userServiceLayer4.Register("removeOwnerUser4", "345HDty6s");
            userServiceLayer4.Login("removeOwnerUser4", "345HDty6s");

            userServiceLayer1.Add_Store_Owner("shopit", "removeOwnerUser3");
            userServiceLayer1.Add_Store_Owner("shopit", "removeOwnerUser4");

            Assert.ThrowsException<Exception>(() => { userServiceLayer3.Remove_Store_Manager("shopit", "removeOwnerUser4"); }, "faild to remove owner that someonelse defined him to be an owner");

            I_User_ServiceLayer userServiceLayer5 = serviceLayer.Connect();
            userServiceLayer5.Register("removeOwnerUser5", "8765GFDf");
            userServiceLayer5.Login("removeOwnerUser5", "8765GFDf");
            userServiceLayer3.Add_Store_Owner("shopit", "removeOwnerUser5");
            ...
            Assert.IsTrue(userServiceLayer5.Add_Product_Store("shopit", "chips", "food", 17, 50, new noDiscount(), new regularPolicy())); 
            Assert.IsTrue(userServiceLayer3.Remove_Store_Owner("shopit", "removeOwnerUser5"));
        ...
        public void remove_owner_remove_all_the_owners_that_defined_by_him_test()
        {
            ...
            userServiceLayer1.Add_Store_Owner("shopit", "removeOwnerUser3");
            userServiceLayer3.Add_Store_Owner("shopit", "removeOwnerUser4");

            Assert.IsTrue(userServiceLayer4.Update_Product_Store("shopit", "cheese cake", "cheese cake", "desserts", 22, 26, new noDiscount(), new regularPolicy()));

            Assert.IsTrue(userServiceLayer1.Remove_Store_Owner("shopit", "removeOwnerUser3"));
            Assert.ThrowsException<Exception>(() => { userServiceLayer4.Update_Product_Store("shopit", "cheese cake", "cheese cake", "cakes", 22, 26, new noDiscount(), new regularPolicy()); }, "no longer owner because his definder has been removed and is no longer owner ");
        ...
        public void not_owner_try_to_remove_an_owner_test()  //bad
        {
            ...
            I_User_ServiceLayer userServiceLayer3 = serviceLayer.Connect();
            userServiceLayer3.Register("removeOwnerUser3", "12345JGth");
            userServiceLayer3.Login("removeOwnerUser3", "12345JGth");
            userServiceLayer1.Add_Store_Owner("shopit", "removeOwnerUser3");

            Assert.ThrowsException<Exception>(() => { tmp_userServiceLayer.Remove_Store_Manager("shopit", "removeOwnerUser3"); }, "only store owner can remove an owner from the store");
            Assert.IsTrue(userServiceLayer3.Update_Product_Store("shopit", "cheese cake", "cheese cake", "cakes", 22, 26, new noDiscount(), new regularPolicy()));
        }
    }
}
