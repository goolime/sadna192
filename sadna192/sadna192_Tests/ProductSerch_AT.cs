...
namespace sadna192.Tests
{
    ...
    public class ProductSearch_AT
    {
        ...
        public void init()
        {
            ...
            if (userServiceLayer2.Register("productSearch_user2", "9876"))
                if (userServiceLayer2.Login("productSearch_user2", "9876"))
                    ...
                    {
                         userServiceLayer2.Add_Product_Store("h&m", "dress", "clothes", 29.90, 5, null, null);
            ...
            if (userServiceLayer3.Register("productSearch_user3", "4455"))
                userServiceLayer3.Login("productSearch_user3", "4455");
        }
        ...
        {   /*    
            ...
            Assert.ThrowsException<Exception>(() => { userServiceLayer3.GlobalSearch("", "food", null, 0, 20, 0, 0); }, "searching with wrong type of product name");
