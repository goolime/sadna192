    ...
    public class RemoveManager_AT
    {
        ...
        public void init()
        {
            ...
            if (userServiceLayer2.Register("removeManager_user2", "87654"))
                userServiceLayer2.Login("removeManager_user2", "87654");
            ...
            if (userServiceLayer1.Register("removeManager_user", "1221"))
                if (userServiceLayer1.Login("removeManager_user", "1221"))
                    ...
                    {
                        userServiceLayer1.Add_Product_Store("shoes store", "heel shoes", "women shoes", 280, 26, null, null);
                        userServiceLayer1.Add_Store_Manager("shoes store", "removeManager_user2" , true, true, true);
                    }  
        }
        ...
        public void remove_shop_manager_that_is_not_manager_test()
        {
            ...
            userServiceLayer3.Register("removeManager_user3", "9999");
        ...
        public void manager_try_to_remove_a_manager_test()  //bad
        {
            ...
            tmp_userServiceLayer.Register("removeManager_tmp_user", "11111");
            userServiceLayer1.Add_Store_Manager("shoes store", "removeManager_tmp_user", true, true, true);

            I_User_ServiceLayer userServiceLayer3 = serviceLayer.Connect();
            userServiceLayer3.Register("removeManager_user3", "12345");
            userServiceLayer3.Login("removeManager_user3", "12345");
            userServiceLayer1.Add_Store_Manager("shoes store", "removeManager_user3", true, true, true);
