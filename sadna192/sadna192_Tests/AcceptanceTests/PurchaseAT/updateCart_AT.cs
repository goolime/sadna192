...
namespace AcceptanceTests
{
    ...
    public class UpdateCart_AT
    {
        ...
        public void init()
        {
            ...
            if (userServiceLayer_seller.Register("updateCart_user", "1221"))
                if (userServiceLayer_seller.Login("updateCart_user", "1221"))              
                    ...
                    {
                        bool apple_product1 = userServiceLayer_seller.Add_Product_Store("MiniMarket", "red apple", "food", 4, 10, null, null);
                        bool cheesecake_product1 = userServiceLayer_seller.Add_Product_Store("MiniMarket", "cheesecake", "food", 15, 5, null, null);
                    }
        ...
        public void update_unvalid_amount_of_product__test()   //Use Case: 2.7.2 Happy-4
        {
            ...
            Assert.ThrowsException<Exception>(() => { userServiceLayer_buyer.Edit_Product_In_ShopingBasket(cheescakeToBuy[0], 1.5); }, "tring to updat to not whole number of producat.   UC 2.7.2 sad-1");
            Assert.AreEqual(userServiceLayer_buyer.Watch_Cart().Count, cart_amount);
        }
