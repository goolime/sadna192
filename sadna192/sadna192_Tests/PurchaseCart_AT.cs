        ...
        public void init()
        {
            ...
            if (userServiceLayer_seller.Register("purchaseCart_user", "1221"))
                if (userServiceLayer_seller.Login("purchaseCart_user", "1221"))
                    ...
                    {
                        userServiceLayer_seller.Add_Product_Store("Renuar", "red dress", "clothes", 45, 10, null, null);  //new regulerPolicy()  new immidiatePolicy() ect. 
                        userServiceLayer_seller.Add_Product_Store("Renuar", "pants", "clothes", 55, 5, null, null);
                        userServiceLayer_seller.Add_Product_Store("mike place", "soda", "drinks", 5, 50, null, null);
                    }
        ...
        public void purchaseCart_happy_test()
        {
            ...
            for (int i = 0; i < redDress.Count; i++)
                if (redDress[i].getStore().getName().Equals("Renuar"))
                    ...
                    */
            Assert.Fail("this test is not done yet");
        }
    }
}
