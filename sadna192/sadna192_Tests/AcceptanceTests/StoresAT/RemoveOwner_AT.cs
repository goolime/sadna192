    ...
    public class RemoveOwner_AT
    {
        ...
        public void init()
        {
            ...
            if (userServiceLayer2.Register("removeOwner_user2", "87654"))
                bool login1 = userServiceLayer2.Login("removeOwner_user2", "87654");
            ...
            if (userServiceLayer1.Register("removeOwner_user", "1221"))
                if (userServiceLayer1.Login("removeOwner_user", "1221"))
                {
                    ...
                    {
                        bool product = userServiceLayer1.Add_Product_Store("shopit", "cheese cake", "food", 28, 6, null, null);
                        bool owner = userServiceLayer1.Add_Store_Owner("shopit", "removeOwner_user2");
                    }
                }          
        }
        ...
        {
            I_User_ServiceLayer userServiceLayer3 = serviceLayer.connect();
            bool ans = userServiceLayer3.Register("removeOwner_user3", "9999");
            ans = userServiceLayer3.Login("removeOwner_user3", "9999");

            I_User_ServiceLayer userServiceLayer4 = serviceLayer.connect();
            ans = userServiceLayer4.Register("removeOwner_user4", "345");
            ans = userServiceLayer4.Login("removeOwner_user4", "345");

            ans = userServiceLayer1.Add_Store_Owner("shopit", "removeOwner_user3");
            ans = userServiceLayer1.Add_Store_Owner("shopit", "removeOwner_user4");
            ...
            ans = userServiceLayer5.Register("removeOwner_user5", "8765");
            ans = userServiceLayer5.Login("removeOwner_user5", "8765");
            ans = userServiceLayer3.Add_Store_Owner("shopit", "removeOwner_user5");
        ...
        public void remove_owner_remove_all_the_owners_that_defined_by_him_test()
        {
            ...
            ans = userServiceLayer1.Add_Store_Owner("shopit", "removeOwner_user3");
            ans = userServiceLayer3.Add_Store_Owner("shopit", "removeOwner_user4");
        ...
        public void not_owner_try_to_remove_an_owner_test()  //bad
        {
            ...
            bool ans = tmp_userServiceLayer.Register("removeOwner_tmp_user", "11111");

            I_User_ServiceLayer userServiceLayer3 = serviceLayer.connect();
            ans = userServiceLayer3.Register("removeOwner_user3", "12345");
            ans = userServiceLayer3.Login("removeOwner_user3", "12345");
            ans = userServiceLayer1.Add_Store_Owner("shopit", "removeOwner_user3");
